...
const Newsletter = () => {
  return (
    <section className="py-20">
      <div className="bg-white dark:bg-dark/50 rounded-lg shadow-md overflow-hidden animate-slideUp">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300 md:w-2/3">
                  ...
                  insights delivered straight to you inbox.
                </p>
              </div>
              <form className="flex flex-col md:flex-row gap-4">
                ...
                <button
                  type="submit"
                  className="text-white bg-primary px-8 py-3 rounded-lg hover:bg-primary/90 transition-colors"
                >
                  Subscribe
                </button>
              </form>
